(function () {
  ...
  const GISCUS_CONFIG = {
    repo: 'alienshun/new-homepage-testing',
    repoId: 'R_kgDOPFvFdg',
    mapping: 'number',
    term: '2',
    reactionsEnabled: '0',
   ...
   * To re-enable: uncomment observeContainer() below and make sure your
   * GitHub repo has the Giscus App installed and Discussion #2 exists.
   *
...
*/
  ...
  function init() {
    // Giscus + theme observer disabled — only update static texts
    updateStaticTexts();
    // observeContainer();
    // observeTheme();
  }
