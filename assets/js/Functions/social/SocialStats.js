(function () {
  ...
  const GC_SITE = 'https://YOUR-SITE-CODE.goatcounter.com';

  const MAPMYVISITORS_MAP_SRC =
    'https://mapmyvisitors.com/map.js?d=YOUR_MAPMYVISITORS_KEY&cl=ffffff&w=a';
  ...
  /*
   * GoatCounter + MapMyVisitors disabled.
   * To re-enable: uncomment scheduleVisibleResourceLoad() below and replace
   * the placeholder keys (YOUR_SITE_CODE, YOUR_MAPMYVISITORS_KEY) above.
   *
